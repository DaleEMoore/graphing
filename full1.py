...
bar_plot = sales_totals.sort_values(ascending=False).plot(kind='bar',legend=None,title="Total Sales by Customer")
#TODO; what should 'by' be?
#TypeError: sort_values() missing 1 required positional argument: 'by'
#TypeError: sort_values() got an unexpected keyword argument 'columns'
#bar_plot = sales_totals.sort_values(columns='ext price',ascending=False).plot(kind='bar',legend=None,title="Total Sales by Customer")
#"counts_.sort_values('num',ascending=False)"
#https://stackoverflow.com/questions/44542563/dataframe-object-has-no-attribute-sort
